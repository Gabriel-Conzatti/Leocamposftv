...
export const obterStatusPagamento = asyncHandler(async (req, res) => {
...
export const criarPreferencaMercadoPago = asyncHandler(async (req, res) => {
        ...
        if (novoStatus !== pagamento.status) {
            ...
            if (novoStatus === 'confirmado') {
                ...
                if (aula && pagamento.aluno.email) {
                    ...
                    const html = emailConfirmacaoPagamento(pagamento.aluno.nome, aula.titulo, dataFormatada, aula.horario, aula.local, aula.preco);
                    await enviarEmail({
...
export const simularPagamento = asyncHandler(async (req, res) => {
...
export const verificarStatusMercadoPago = asyncHandler(async (req, res) => {
