 ...
 */
export const enviarEmail = async (opcoes: EmailOpcoes): Promise<boolean> => {
  try {
 ...
 */
export const emailNovaInscricao = (
  nomeAluno: string,
  nomeAula: string,
  dataAula: string,
  horarioAula: string,
 ...
 */
export const emailConfirmacaoPagamento = (
  nomeAluno: string,
  nomeAula: string,
  dataAula: string,
  horarioAula: string,
 ...
 */
export const emailNovaAulaDisponivel = (
  nomeAluno: string,
  nomeAula: string,
  dataAula: string,
  horarioAula: string,
 ...
 */
export const emailLembreteAula = (
  nomeAluno: string,
  nomeAula: string,
  dataAula: string,
  horarioAula: string,
 ...
 */
export const emailAulaCancelada = (
  nomeAluno: string,
  nomeAula: string,
  dataAula: string,
  horarioAula: string,
  motivo: string = 'Motivos não previstos'
): string => {
  return `
    <!DOCTYPE html>
    <html>
 ...
 */
export const emailRecuperacaoSenha = (
  nomeUsuario: string,
  tokenReset: string,
 ...
 */
export const emailSenhaAlterada = (
  nomeUsuario: string,
  dataHora: string
): string => {
  return `
